...
// include: /tmp/tmp0tae8w3c.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/PolarClock.data';
      var REMOTE_PACKAGE_BASE = 'PolarClock.data';
...
Module['FS_createPath']("/", "shaders", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_bin/PolarClock.data');
      }
      Module['addRunDependency']('datafile_bin/PolarClock.data');
    ...
    loadPackage({"files": [{"filename": "/assets/LiberationSans-Regular.otf", "start": 0, "end": 296928}, {"filename": "/assets/Roboto-Regular.ttf", "start": 296928, "end": 812028}, {"filename": "/assets/RobotoMono-Bold.ttf", "start": 812028, "end": 899724}, {"filename": "/shaders/arc.frag", "start": 899724, "end": 899868}, {"filename": "/shaders/arc.vert", "start": 899868, "end": 900055}, {"filename": "/shaders/text.frag", "start": 900055, "end": 900461}, {"filename": "/shaders/text.vert", "start": 900461, "end": 900772}], "remote_package_size": 900772});

  })();

// end include: /tmp/tmp0tae8w3c.js
// include: /tmp/tmpz2lcsxxy.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpz2lcsxxy.js
// include: /tmp/tmp9fjwtmqp.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp9fjwtmqp.js
...
function findWasmBinary() {
  return locateFile('PolarClock.wasm');
}
